...
namespace SkiingMinigame.Services.Spawners
{
    ...
    {
        public RockSpawner(List<ObstacleSprite> obstacle, Game1 context, double minSpawnSpeed, double maxSpawnSpeed) : base(obstacle, context, minSpawnSpeed, maxSpawnSpeed)
        {
        }
